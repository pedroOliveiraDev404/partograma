...
import PartogramaRuptureGemelar from "./PartogramaRuptureGemelar";
  ...
  return (
    <TabPanel value={selectedTabIndex} index={0}>
      <div className="tab-dilatacao__container">
        <h6 className="partograma-modal__tab-title">Ruptura da bolsa</h6>
...
export default PartogramaRuptureTab;
