...
import "./TimelineContraction.css";
    ...
    >
      ...
      >
        <div className="timeline-liquido-amniotico__modal-container">
          ...
          />
          <strong className="timeline-liquido-amniotico__modal-title">Contrações/15min</strong>
          
          <DatePicker/>
          
          <div className="timeline-contraction__input-box">
