      ...
      {isModalOpen && (
        ...
        >
          <div className="timeline-liquido-amniotico__modal-container">
            ...
            />
            <strong className="timeline-liquido-amniotico__modal-title">Ocitocina</strong>
            <DatePicker/>
            {edit && (
            ...
            <div className="timeline-oxytocin__input-box">
            ...
            <div className="timeline-oxytocin__submit-box">
              {init && (
                <button
